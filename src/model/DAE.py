# DAE.py
# This file contains the DAE class, which is a deep autoencoder model for image denoising.
# It is used to train the model on the BraTS dataset.
# The DAE class is a subclass of the nn.Module class, which is the base class for all neural network modules in PyTorch.
# The DAE class has the following methods:
# __init__: initializes the DAE model
# add_noise: adds noise to the input image
import sys
import torch
